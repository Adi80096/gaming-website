...
.hero-info button:hover{
    ...
    color: white;
    box-shadow:0 0 15px rgb(0, 166, 255);
}
.Gaming-text{
    font-size: 120px;
    font-family: Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif;
...
.next-btn:hover{
    ...
    height: 200px;
    opacity: 0.81;
    box-shadow: 0 0 15 rgba(255, 255, 255, 0.616);
    box-shadow:0 0 15px rgb(0, 166, 255);
}
.about-section{
    width: 100%;
...
.contact-section .img1{
    ...
    height: 400px;
    width: 400px;
    clip-path: polygon(33% 0, 76% 3%, 100% 53%, 75% 100%, 25% 100%, 0 38%);
}
...
.contact-section .img2{
    ...
    height: 200px;
    width: 200px;
    clip-path: polygon(10% 1%, 94% 1%, 83% 100%, 20% 81%);
}
